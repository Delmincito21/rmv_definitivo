  ...
  useEffect(() => {
    const fetchVentaData = async () => {
      try {
        ...
        const ventaInfo = await ventaResponse.json();
        ...
        const pagoResponse = await fetch(`http://localhost:3000/pagos/venta/${id_venta}`);
    ...
    <div className="factura-container">
      <div className="factura-content">
        ...
        <div className="factura-buttons">
          ...
          <button className="action-button close" onClick={() => navigate('/ventas')}>
            Volver
          </button>
        </div>
      </div>
